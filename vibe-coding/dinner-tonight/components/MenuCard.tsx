      ...
      <View style={styles.section}>
        ...
        <View style={styles.altRow}>
          {alternatives.map((alt) => (
            <View key={alt} style={[styles.altTag, { backgroundColor: isDark ? colors.surfaceDark : '#F2F2F7' }]}>
              <Text style={[styles.altText, { color: mutedColor }]}>{alt}</Text>
            </View>
          ))}
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  emoji: { fontSize: 56 },
  menuName: { fontSize: 30, fontWeight: '800', marginBottom: 8, textAlign: 'center' },
  ...
  altTag: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: 20 },
  altText: { fontSize: 14, fontWeight: '500' },
  confirmBtn: {
    backgroundColor: colors.primary,
