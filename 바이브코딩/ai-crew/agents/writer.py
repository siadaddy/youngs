...
지킬 것:
- 질문은 글 전체에서 딱 1개만. 질문 여러 개 금지.
- 같은 표현 반복 금지 ("어떻게 될지", "이러한", "이런 상황" 등)
- "BMW 딜러에서 일하는 나", "내가 이 업계에서" 같은 페르소나 직접 언급 금지 — 느낌으로만
- 없는 수치·사실 창작 절대 금지
- 한국어와 영어만. 독일어(geben, aber 등)·베트남어·아랍어 등 외국어 단어 금지
- 레이블([사실], [분석] 등) 달지 마
- 전체 350~450자
